...
class ChecklistElement {
  ...
  factory ChecklistElement.fromJson(String str) =>
  ...
  factory ChecklistElement.fromMap(Map<String, dynamic> json) =>
      ChecklistElement(
        ...
        checklistData: List<ChecklistData>.from(
            json["checklistData"].map((x) => ChecklistData.fromMap(x))),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "checklistData":
            List<dynamic>.from(checklistData!.map((x) => x.toMap())),
      };
}

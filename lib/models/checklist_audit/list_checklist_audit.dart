...
class ListChecklistAudit {
    ...
    factory ListChecklistAudit.fromMap(Map<String, dynamic> json) => ListChecklistAudit(
        checklistAudit: List<ChecklistAudit>.from(json["ChecklistAudit"].map((x) => ChecklistAudit.fromMap(x))),
    );

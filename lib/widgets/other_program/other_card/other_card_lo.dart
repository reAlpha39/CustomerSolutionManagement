...
class OtherCardLo extends StatelessWidget {
  @override
...
class ExpandedLoData extends StatelessWidget {
  ...
  Future<bool> resultTextField({int index}) {
    return Get.defaultDialog(
        ...
        confirmTextColor: Colors.black87,
        onConfirm: () {
          controller.textFieldOP('lo')[index] =
  ...
  TextButton buildTextButtonRemark(int id) {
    return TextButton(
      ...
      child: Obx(() => Text(controller.textFieldLO[id] == ""
          ? 'Klik disini'
          : "${controller.textFieldLO[id]}")),
    );
  }
  ...
  TextButton buildTextButtonAssessment(int id) {
    return TextButton(
      ...
      child: Obx(() => Text(controller.radioIndexLO[id] == -1
          ? 'Pilih disini'
          : '${controller.radioData[controller.radioIndexLO[id]]}')),
    );
  }
                    ...
                    SingleChildScrollView(
                      child: Padding(
                        ...
                        child: Container(
                          width: 160,
                          child: Text(
                              'Cek apakah sudah ada struktur organisasi  untuk Logistic Department?'),
                        ),
                      ),
                    ),
                  ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Text(
                                  'Melihat apakah ada struktur organisasi Logistic Depertement'),
                            ],
                          ),
                        ),
                      ),
                  ...
                  DataCell(SingleChildScrollView(
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Text('Struktur organisasi Logistic departement'),
                          ],
                        ),
                      ),
                    ),
                    ...
                    SingleChildScrollView(
                      child: Padding(
                        ...
                        child: Container(
                          width: 160,
                          child: Text(
                              'Cek apakah sudah ada tugas dan tanggung jawab untuk setiap personel di Logistic  Department?'),
                        ),
                      ),
                    ),
                  ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Text(
                                  'Melihat apakah sudah ada tugas dan tanggung jawab untuk setiap personel di Logistic Departement'),
                            ],
                          ),
                        ),
                      ),
                    ...
                    SingleChildScrollView(
                      child: Padding(
                        ...
                        child: Container(
                          width: 160,
                          child: Text(
                              'Cek  salinan tugas dan tanggung jawab untuk setiap personel di Logistic Department'),
                        ),
                      ),
                    ),
                  ),
                    ...
                    SingleChildScrollView(
                      child: Padding(
                        ...
                        child: Container(
                          width: 160,
                          child: Text(
                              'Cek bagaimana cara menghitung  minimum kecukupan manpower di Logistic Department ? '),
                        ),
                      ),
                    ),
                  ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Text(
                                  'Interview dengan kabag Logistic cara/metode perhitungan man power')
                            ],
                          ),
                        ),
                      ),
                  ...
                  DataCell(SingleChildScrollView(
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Text('Hasil interview dengan kabag Logistic'),
                          ],
                        ),
                      ),
                    ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Text(
                                  'Interview dengan kabag Logistic terkait perhitungan man power apakah sesuai dengan target KPI dan Roster'),
                            ],
                          ),
                        ),
                      ),

...
class OtherCardPo extends StatelessWidget {
  @override
...
class ExpandedPoData extends StatelessWidget {
  ...
  Future<bool> resultTextField({int index}) {
    return Get.defaultDialog(
        ...
        confirmTextColor: Colors.black87,
        onConfirm: () {
          controller.textFieldOP('po')[index] =
  ...
  TextButton buildTextButtonRemark(int id) {
    return TextButton(
      ...
      child: Obx(() => Text(controller.textFieldPO[id] == ""
          ? 'Klik disini'
          : "${controller.textFieldPO[id]}")),
    );
  }
  ...
  TextButton buildTextButtonAssessment(int id) {
    return TextButton(
      ...
      child: Obx(() => Text(controller.radioIndexPO[id] == -1
          ? 'Pilih disini'
          : '${controller.radioData[controller.radioIndexPO[id]]}')),
    );
  }
                    ...
                    SingleChildScrollView(
                      child: Padding(
                        ...
                        child: Container(
                          width: 160,
                          child: Text(
                              'Cek apakah sudah ada struktur organisasi  untuk Plant Department? '),
                        ),
                      ),
                    ),
                  ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Text(
                                  'Melihat apakah ada struktur organisasi Plant Depertement'),
                            ],
                          ),
                        ),
                      ),
                  ...
                  DataCell(SingleChildScrollView(
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Text('Struktur organisasi plant departement'),
                          ],
                        ),
                      ),
                    ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Text(
                                  'Melihat apakah sudah ada tugas dan tanggung jawab untuk setiap personel di Plant Departement'),
                            ],
                          ),
                        ),
                      ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Text(
                                  'Interview dengan kabag plant cara/metode perhitungan man power')
                            ],
                          ),
                        ),
                      ),
                  ...
                  DataCell(SingleChildScrollView(
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Text('Hasil interview dengan kabag plant'),
                          ],
                        ),
                      ),
                    ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Text(
                                  'Interview dengan kabag plant terkait perhitungan man power apakah sesuai dengan target KPI dan Roster'),
                            ],
                          ),
                        ),
                      ),

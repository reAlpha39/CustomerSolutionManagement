...
class OtherCardPro extends StatelessWidget {
  @override
...
class ExpandedProData extends StatelessWidget {
  ...
  Future<bool> resultTextField({int index}) {
    return Get.defaultDialog(
        ...
        confirmTextColor: Colors.black87,
        onConfirm: () {
          controller.textFieldOP('pro')[index] =
  ...
  TextButton buildTextButtonRemark(int id) {
    return TextButton(
      ...
      child: Obx(() => Text(controller.textFieldPRO[id] == ""
          ? 'Klik disini'
          : "${controller.textFieldPRO[id]}")),
    );
  }
  ...
  TextButton buildTextButtonAssessment(int id) {
    return TextButton(
      ...
      child: Obx(() => Text(controller.radioIndexPRO[id] == -1
          ? 'Pilih disini'
          : '${controller.radioData[controller.radioIndexPRO[id]]}')),
    );
  }
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Text(
                                  'Melihat apakah ada struktur organisasi Production Depertement'),
                            ],
                          ),
                        ),
                      ),
                  ...
                  DataCell(SingleChildScrollView(
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Text('Struktur organisasi Production departement'),
                          ],
                        ),
                      ),
                    ),
                    ...
                    SingleChildScrollView(
                      child: Padding(
                        ...
                        child: Container(
                          width: 160,
                          child: Text(
                              'Cek apakah sudah ada tugas dan tanggung jawab untuk setiap personel di Production Department? '),
                        ),
                      ),
                    ),
                  ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Text(
                                  'Melihat apakah sudah ada tugas dan tanggung jawab untuk setiap personel di Production Departement'),
                            ],
                          ),
                        ),
                      ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Text(
                                  'Interview dengan kabag Production cara/metode perhitungan man power')
                            ],
                          ),
                        ),
                      ),
                  ...
                  DataCell(SingleChildScrollView(
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Text('Hasil interview dengan kabag Production'),
                          ],
                        ),
                      ),
                    ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Text(
                                  'Interview dengan kabag Production terkait perhitungan man power apakah sesuai dengan target KPI dan Roster'),
                            ],
                          ),
                        ),
                      ),

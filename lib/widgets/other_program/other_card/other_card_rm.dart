...
class OtherCardRm extends StatelessWidget {
  @override
...
class ExpandedRmData extends StatelessWidget {
  ...
  Future<bool> resultTextField({int index}) {
    return Get.defaultDialog(
        ...
        confirmTextColor: Colors.black87,
        onConfirm: () {
          controller.textFieldOP('rm')[index] =
  ...
  TextButton buildTextButtonRemark(int id) {
    return TextButton(
      ...
      child: Obx(() => Text(controller.textFieldRM[id] == ""
          ? 'Klik disini'
          : "${controller.textFieldRM[id]}")),
    );
  }
  ...
  TextButton buildTextButtonAssessment(int id) {
    return TextButton(
      ...
      child: Obx(() => Text(controller.radioIndexRM[id] == -1
          ? 'Pilih disini'
          : '${controller.radioData[controller.radioIndexRM[id]]}')),
    );
  }
